        ...
        <div className="left-side">
          ...
          <form onSubmit={handleSubmit} style={{marginTop:"15%"}}>
            ...
            <input
              ...
              id="pwd1"  
            />
            <button type="submit" id="sub-butt" className="btn btn" style={{marginRight:"-32%", background:"#3f8efc"}}>
              Vérifier
            </button>
            <button onClick={ () => HandlerAnnuler()} type="button" id="sub-butt" className="btn btn-danger" style={{background:"#3f8efc"}}>
              Retour
            </button>
          </form> <br/>
