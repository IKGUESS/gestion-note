...
function ModifierEtudiant(props) {
  ...
  const [enableFilier, setEnableFilier] = useState(true);
  ...
  useEffect(() => {
    etudiantService.getEtudiantById(props.match.params.cin).then((res) => {
      ...
      setDateNaissance(moment(new Date(etudiant.dateNaissance)).format('YYYY-MM-DD'));
      ...
      setCodeFil(etudiant.filiere.codeFil);
      setSection(etudiant.section);
      setEnableFilier(false);
    });
  ...
  const ModifierEtudiant = (e) => {
    ...
    if (formIsValid) {
      ...
      etudiantService.updateEtudiant(etudiant, props.match.params.cin).then(() => {
      ...
      <div className="container py-5">
        <div className="row justify-content-center">
          ...
          >
            ...
            <form onSubmit={ModifierEtudiant}>
              {[
                { label: 'CIN', value: cin, onChange: changeCINHandler, type: 'text', placeholder: 'CIN', required: true, readOnly: true },
                    ...
                    {field.type === 'select' ? (
                      ...
                      <input
                        ...
                        style={{
                          ...
                          fontSize: '0.9rem',
                          transition: 'border-color 0.3s ease, box-shadow 0.3s ease',
                          backgroundColor: field.readOnly ? '#e9ecef' : '#fff',
                        }}
