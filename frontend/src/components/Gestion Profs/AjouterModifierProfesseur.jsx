...
function AjouterModifierProfesseur(props) {
  ...
  const ident = props.match.params.CINProf;
  ...
  const saveProfesseur = async (evt) => {
    evt.preventDefault();
    if (formIsValid) {
      ...
      if (ident === '_add') {
        ...
        professeurService.getProfesseurById(cin).then((res) => {
          ...
          if (cinExists.cin !== cin) {
            professeurService.createProfesseur(professeur).then(() => {
        ...
        professeurService.updateProfesseur(ident, professeur).then(() => {
            ...
            <form onSubmit={saveProfesseur}>
              {[
                ...
                },
                {
                  label: 'Nationalité',
                  value: nationalite,
                  onChange: changeNationaliteHandler,
                  type: 'text',
              ...
              <div className="form-group row mt-4">
                <div className="col-sm-12 text-center">
                  <button
                    ...
                    aria-label="Enregistrer le professeur"
                  >
                    Enregistrer
                  </button>
                  <button
