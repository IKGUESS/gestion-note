...
import { FaUserPlus, FaUsers, FaChalkboardTeacher } from 'react-icons/fa';
...
const InterfaceProfs = () => {
  ...
  function addProfesseur() {
    history.replace('/ajouter-modifier-prof/_add');
  }
  ...
  const navigations = [
    {
      ...
      onClick: addProfesseur,
    },
    {
      icon: <FaUsers />,
      label: 'Consulter Professeur',
      onClick: consulterProf,
    },
    {
  ...
  return (
    ...
    >
      ...
      <div className="container py-5">
        ...
        >
          Gestion des Professeurs - ENSA Béni Mellal
        </h4>
