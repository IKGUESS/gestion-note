...
import { FaLayerGroup, FaStream, FaGraduationCap, FaBook } from 'react-icons/fa';
  ...
  const navigations = [
    {
      ...
      onClick: lienInterfaceNiveaux,
    },
    {
      icon: <FaStream />,
      label: 'Gestion Filières',
      onClick: lienInterfaceFilieres,
    },
    {
      icon: <FaGraduationCap />,
      label: 'Gestion Niveaux Scolaires',
      onClick: lienInterfaceNiveauxScolaires,
    },
    {
      icon: <FaBook />,
      label: 'Gestion Modules',
      onClick: lienInterfaceModules,
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="container py-5">
        ...
        >
          Gestion des Niveaux et Modules - ENSA Béni Mellal
        </h4>
