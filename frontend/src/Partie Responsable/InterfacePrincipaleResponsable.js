...
const InterfaceResponsable = () => {
  ...
  const navigations = [
    { path: '/interface-niveau-scolaire-respo', icon: <FaLayerGroup />, label: 'Gestion Niveaux Scolaires' },
    { path: '/interface-module-respo', icon: <FaBook />, label: 'Gestion Modules' },
    { path: '/gestion-absences-respo', icon: <FaCalendarTimes />, label: 'Gestion Absences' },
  ];
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#e7f1ff' }}>
      ...
      <div className="container py-5">
        ...
        >
          Interface Responsable - ENSA Béni Mellal
        </h4>
