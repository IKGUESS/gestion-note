...
const HeaderResponsable = () => {
  ...
  const AccueilRespo = () => {
    history.push('/interface-principale-responsable');
  };
      ...
      >
        <div className="container">
          ...
          <a
            ...
            href="/interface-principale-responsable"
            onClick={(e) => {
              e.preventDefault();
              AccueilRespo();
            }}
            ...
            <div className="d-flex align-items-center">
              ...
              <div className="d-none d-lg-flex flex-column align-items-end me-3">
                {responsable ? (
                  ...
                  >
                    {responsable.nom || ''} {responsable.prenom || ''}, {responsable.cin || 'N/A'}
                  </h5>
                ) : (
              ...
              <div className="navbar-nav d-flex flex-row flex-lg-row align-items-center">
                <button
                  ...
                  aria-label="Retour à l'accueil responsable"
                >
                  Accueil
                </button>
                <button
