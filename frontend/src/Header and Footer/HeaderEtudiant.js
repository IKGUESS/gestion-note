...
const HeaderEtudiant = () => {
  ...
  const AccueilEtudiant = () => {
    history.push('/interface-principale-etudiant');
  };
      ...
      >
        <div className="container">
          ...
          <a
            ...
            href="/interface-principale-etudiant"
            onClick={(e) => {
              e.preventDefault();
              AccueilEtudiant();
            }}
            ...
            <div className="d-flex align-items-center">
              ...
              <div className="d-none d-lg-flex flex-column align-items-end me-3">
                {etudiant ? (
                  ...
                  >
                    {etudiant.nom || ''} {etudiant.prenom || ''}, {etudiant.cin || 'N/A'}
                  </h5>
                ) : (
