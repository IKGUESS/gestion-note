            ...
            <div className="d-flex align-items-center">
              ...
              <div className="d-none d-lg-flex flex-column align-items-end me-3">
                {responsable ? (
                  ...
                  >
                    {responsable.nom} {responsable.prenom}, {responsable.cin}
                  </h5>
                ) : (
                  <span style={{ color: '#343a40', fontSize: '0.9rem' }}></span>
                )}
              </div>
      ...
      >
        ...
        >
          <p className="mb-2">
            ...
            <a href="mailto:ensabm.contact@usms.ma" style={{ color: '#4dabf7', textDecoration: 'none' }}>
              ensabm.contact@usms.ma
            </a>
          </p>
          <p className="mb-2">
            <FaInfoCircle style={{ marginRight: '0.5rem', color: '#4dabf7' }} />
            <a href="tel:+212523424300" style={{ color: '#4dabf7', textDecoration: 'none' }}>
              (+212) 523 424 300
            </a>
          </p>
          <p className="mb-0">
